...
document.querySelectorAll("button")[1].onclick = function () {
  ...
  switch (tipo) {
    case "img/foto1.jpg":
      ...
      document.querySelectorAll("button")[0].removeAttribute("disabled", "");//desabilita el boton 0
      break;
    case "img/foto2.jpg":
    ...
    case "img/foto4.jpg":
      ...
      document.querySelectorAll("button")[1].setAttribute("disabled", "");//desabilita el boton 1
      break;
    default:
